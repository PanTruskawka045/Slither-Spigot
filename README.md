...
![In-world score and survival-time leaderboards with player-head pixels](.docs/leaderboards.png)

The main menu is a gui built with text displays and packets.

![The gaze-controlled skin selection and start menu](.docs/lobby-menu.png)
