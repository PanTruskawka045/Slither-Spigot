 ...
 * <a href="https://gist.github.com/aerulion/9c5aac21c3efa5aa03b6f875dbe808de">Source</a>
 */
...
public enum BitmapGlyphInfo {
  ...
  /**
   * Gets the rendered width of a string in pixels using the default Minecraft bitmap font.
   *
   * @param text the text to measure
   * @return the width in pixels
   */
  public static int getStringWidth(final @NotNull String text) {
    int width = 0;

    for (int index = 0; index < text.length(); index++) {
      BitmapGlyphInfo glyphInfo = getBitmapGlyphInfo(text.charAt(index));
      if (glyphInfo.width == -1) {
        continue;
      }

      if (glyphInfo.highSurrogate != null && (index == 0 || text.charAt(index - 1) != glyphInfo.highSurrogate)) {
        glyphInfo = DEFAULT;
      }

      width += glyphInfo.width(false) + 1;
    }
